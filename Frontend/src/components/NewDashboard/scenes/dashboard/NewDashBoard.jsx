...
const NewDashboard = () => {
    ...
    useEffect(() => {
        setLoading(true);
        Promise.all([
            axios.get(`${BASE_URL}/api/createVoter/getVoters`), // Fetch voters
            axios.get(`${BASE_URL}/api/newCandidate/getCandidate`) // Fetch candidates
        ])
        .then(([voterResponse, candidateResponse]) => {
            ...
            const votersVoted = voterData.filter(voter => voter.voteStatus === true).length; // Count where voteStatus is true
    
            setData({
                voters: voterData.length,
                candidates: candidateData.length, // Assuming candidateData is an array
                voted: votersVoted,
            });
            setLoading(false);
        })
    ...
    // useEffect(() => {
    //     setLoading(true);
    //     axios.get(`${BASE_URL}/ap/newCandidate/getCandidate`)
    //         .then((response) => {

...
const Login = () => {
    ...
    const handleLogin = async () => {
        setLoading(true);
        try {
            const response = await axios.post(`${BASE_URL}/api/createVoter/login`, { email, password });
            const voterst = response.data.voterObject;
            console.log(response.data.voterObject)
                ...
                <p>Use user@gmail.com as email and 123 as password</p>
                    ...
                    <div className="signin-content">
                        ...
                        <div className="signin-image">
                            ...
                            <Link to="/Signup" className="signup-image-link">Create an account 111</Link>
                        </div>
